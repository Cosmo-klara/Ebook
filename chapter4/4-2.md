...
```sql
    ...
    (
        ...
        buyer_id     INT     NULL,
        PRIMARY KEY (r_id),
        FOREIGN KEY sellers_id (seller_id) REFERENCES players (p_id) ON DELETE CASCADE,
        FOREIGN KEY buyers_id (buyer_id) REFERENCES players (p_id) ON DELETE CASCADE,
        FOREIGN KEY items_id (ri_id) REFERENCES items (i_id) ON DELETE CASCADE
    ...
    (
        ...
        PRIMARY KEY (mi_id),
        FOREIGN KEY items_id (mi_id) REFERENCES items (i_id) ON DELETE CASCADE
    ) AUTO_INCREMENT = 1001;
